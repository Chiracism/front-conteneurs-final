...
export default function UserMoreMenu({ idCountrie, indexCountrie, nameCountrie, sendInformation }) {
  ...
  const modifyCountrie = () => {
    axios
      .put(
        `${process.env.REACT_APP_BASE_URL}/countrie/${idCountrie}`,
        {
          index,
          name
        },
  ...
  return (
    <>
      ...
      >
        ...
        <MenuItem sx={{ color: 'red' }} onClick={() => deleteCountrie()}>
          <ListItemIcon>
